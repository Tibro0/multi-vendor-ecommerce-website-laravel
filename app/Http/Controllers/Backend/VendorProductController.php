...
class VendorProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $imagePath = $this->uploadImage($request, 'image', 'uploads/vendor_product_thumb_image');
    ...
    public function update(Request $request, string $id)
    {
        ...
        /** Handle the image Upload */
        $imagePath = $this->updateImage($request, 'image', 'uploads/vendor_product_thumb_image', $product->thumb_image);
