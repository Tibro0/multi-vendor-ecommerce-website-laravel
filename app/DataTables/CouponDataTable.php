    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                ...
                $deleteBtn = "<a href='".route('admin.coupons.destroy', $query->id)."' id='delete' class='btn btn-danger ml-2'><i class='far fa-trash-alt'></i><a/>";
            ...
            ->addColumn('discount_type', function($query){
                if ($query->discount_type == 'percent') {
                    return '<i class="badge badge-success">Percent</i>';
                }elseif ($query->discount_type == 'amount') {
                    return '<i class="badge badge-warning">Amount</i>';
                }
            })
            ...
            ->rawColumns(['status', 'action', 'discount_type'])
            ->setRowId('id');
    }
