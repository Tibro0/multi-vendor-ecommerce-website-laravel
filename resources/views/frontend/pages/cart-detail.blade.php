...
@push('frontend-css')
    <title>{{ $settings->site_name }} | Cart Details</title>
@endpush
                                        ...
                                        <tr class="d-flex">
                                            ...
                                            <td class="wsus__pro_select">
                                                <div class="product_qty_wrapper">
                                                    ...
                                                    <input class="product-qty border" data-rowid="{{ $item->rowId }}"
...
@push('frontend-js')
    ...
    <!-- Product increment or decrement button -->
    <script>
