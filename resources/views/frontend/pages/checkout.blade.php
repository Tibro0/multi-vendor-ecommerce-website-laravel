...
@push('frontend-css')
    <title>{{ $settings->site_name }} | Checkout</title>
@endpush
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-7">
                    <div class="wsus__check_form">
                        <h5>Shipping Details <a class="common_btn" href="javascript:;" data-bs-toggle="modal"
        ...
        $(document).ready(function() {
            ...
            $('#submitCheckoutForm').on('click', function(e) {
                ...
                if ($('#shipping_method_id').val() === '') {
                    toastr.error('Shipping Method is Requerd.');
                } else if ($('#shipping_address_id').val() === '') {
                    toastr.error('Shipping Address is Requerd.');
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data.status === 'success') {
                                $('#submitCheckoutForm').text(
                                    'Place Order');
                                // redirect user next page
